...
describe('test get bank statement service', () => {
    ...
    it('return list of transactions with 200 status', async (done) => {
        ...
        await createAndSaveMockDeposit(fullAccountNumber, branchNumber);
        await createAndSaveMockDeposit(fullAccountNumber, branchNumber);
        await createAndSaveMockDeposit(fullAccountNumber, branchNumber);

        const expected = [{ "transactionType": "DP", "value": 521.36, "actionType": "A", "labelDescription": "Bianca Nalien da Cunha Pereira | Banco Raiz", "branchNumber": "0001", "fullAccountNumber": fullAccountNumber, "operation": { "payingSource": { "bankName": "Banco Raiz", "bankNumber": "123", "branchNumber": "2345", "fullAccountNumber": "654321-0", "clientName": "Bianca Nalien da Cunha Pereira" }, "depositType": "DOC" }, "date": "26/08/2020 11:37:22" }, { "transactionType": "DP", "value": 521.36, "actionType": "A", "labelDescription": "Bianca Nalien da Cunha Pereira | Banco Raiz", "branchNumber": "0001", "fullAccountNumber": fullAccountNumber, "operation": { "payingSource": { "bankName": "Banco Raiz", "bankNumber": "123", "branchNumber": "2345", "fullAccountNumber": "654321-0", "clientName": "Bianca Nalien da Cunha Pereira" }, "depositType": "DOC" }, "date": "26/08/2020 11:37:22" }, { "transactionType": "DP", "value": 521.36, "actionType": "A", "labelDescription": "Bianca Nalien da Cunha Pereira | Banco Raiz", "branchNumber": "0001", "fullAccountNumber": fullAccountNumber, "operation": { "payingSource": { "bankName": "Banco Raiz", "bankNumber": "123", "branchNumber": "2345", "fullAccountNumber": "654321-0", "clientName": "Bianca Nalien da Cunha Pereira" }, "depositType": "DOC" }, "date": "26/08/2020 11:37:22" }];

        request(appMock)
            .get('/account/bank-statement')
            .query({ fullAccountNumber: fullAccountNumber, branchNumber: branchNumber })
    ...
    it('return another page of transactions list with 200 status', async (done) => {
        ...
        request(appMock)
            .get('/account/bank-statement')
            .query({ fullAccountNumber: fullAccountNumber, branchNumber: branchNumber, page: 2 })
            .expect(200, expected, done);
    });
